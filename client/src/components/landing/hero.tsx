...
const Hero = () => {
  return (
    <div className="flex flex-col items-center justify-center h-[calc(80vh-4rem)] bg-gradient-to-b from-[#000000] to-[#0B192C] text-white px-4 pt-32">
      ...
      >
        <button className="bg-[#5CB338] text-[#000000] text-lg md:text-xl font-semibold px-8 py-4 rounded-lg shadow-md hover:bg-[#4AA62B] transition duration-300 font-sans">
          Get Started
        </button>
      </motion.div>
    </div>
