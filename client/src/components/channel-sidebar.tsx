...
const ChannelSidebar = ({
  ...
  return (
    <div className="w-60 bg-[#2C2F33] flex flex-col text-gray-300 overflow-hidden">
      <div className="p-4 border-b border-gray-700 flex justify-between ">
        <h2 className="text-lg font-bold truncate">{workspace?.name}</h2>
      ...
      <div className="flex-1 overflow-y-auto">
        <div className="p-3">
          ...
          {channels.map((channel) => (
            <div
              key={channel.id}
              className="flex items-center justify-between mb-1 cursor-pointer hover:bg-gray-700 rounded p-1 group"
            >
              <div
              ...
              workspace?.owner_id === users?.id ? (
                <button
                  ...
                  className="text-gray-400 hover:text-customGreen opacity-0 group-hover:opacity-100"
                >
                  <FaCog />
                </button>
              ) : null}
            ...
            <>
              {member.id !== users?.id ? (
                <div
                  ...
                  className="flex items-center mb-1 cursor-pointer hover:bg-gray-700 rounded p-1"
                >
                  <FaUserCircle
                    className={`${
      ...
      <div className="p-3 border-t border-gray-700">
        ...
        >
          <FaUserCircle className="w-8 h-8 text-[#3ba55c] mr-3 flex-shrink-0" />
          <div className="min-w-0">
            <div className="font-semibold truncate">{users?.username}</div>
