...
const Dashboard2 = () => {
    ...
    return ( 
        <div className="w-screen h-screen flex">
            ...
            <Sidebar joinopen={joinopen} setJoinopen={setJoinopen}  inviteopen={inviteopen} setInviteopen={setInviteopen} setopen={setOpen} workspaces={workspaces} selectedWorkspace={selectedWorkspace} setSeletedWorkspace={setSeletedWorkspace}/>
            ...
            <InviteModal workspaceId={selectedWorkspace} inviteopen={inviteopen} setInviteopen={setInviteopen}/>
            <JoinWorkspace  joinopen={joinopen} setJoinopen={setJoinopen}/>
        </div>
     );
}
