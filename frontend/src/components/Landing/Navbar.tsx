      ...
      {isMenuOpen && (
        <div className="md:hidden bg-[#000000]/95 backdrop-blur-sm">
          <div className="container mx-auto px-4 py-4 flex flex-col space-y-4">
            <Link
              to="/signin"
              className="w-full px-6 py-2 text-[#5CB338] border-2 border-[#5CB338] rounded-full font-semibold hover:bg-[#5CB338] hover:text-[#000000] transition-all duration-300 font-heading"
            >
              Sign In
            </Link>
            <Link
              to="/signup"
              className="w-full px-6 py-2 bg-[#5CB338] text-[#000000] border-2 border-[#5CB338] rounded-full font-semibold hover:bg-transparent hover:text-[#5CB338] transition-all duration-300 font-heading"
            >
              Sign Up
            </Link>
          </div>
